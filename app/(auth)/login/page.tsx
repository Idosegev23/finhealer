      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-white border-2 border-gray-300 hover:border-primary hover:bg-gray-50 text-dark font-medium py-4 px-6 rounded-lg transition duration-200 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>

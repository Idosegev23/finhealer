...
3. חלץ את **התאריך האמיתי מהקבלה** - לא תאריך היום!

4. אם יש כמה פריטים בקבלה - חלץ את כולם

5. אם זו קבלה פשוטה (1-2 פריטים) - השתמש בשם בית העסק כ-vendor

6. סווג לקטגוריה המדויקת ביותר מהרשימה

7. **בדיקה כפולה:** לפני שתחזיר את ה-amount, ודא שזה באמת סכום כסף (עם נקודה עשרונית או מספר שלם) ולא מספר קבלה, מספר קופה או מזהה אחר.`
              },
              {
                role: 'user',
                content: [

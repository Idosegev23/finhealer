...
🎯 **חשוב במיוחד לקבלות:**
1. **הבדל קריטי בין מספר קבלה לעלות:**
...
2. חלץ את **התאריך האמיתי מהקבלה** - לא תאריך היום!

3. אם יש כמה פריטים בקבלה - חלץ את כולם

4. אם זו קבלה פשוטה (1-2 פריטים) - השתמש בשם בית העסק כ-vendor

5. סווג לקטגוריה המדויקת ביותר מהרשימה

6. **בדיקה כפולה:** לפני שתחזיר את ה-amount, ודא שזה באמת סכום כסף (עם נקודה עשרונית או מספר שלם) ולא מספר קבלה או מזהה אחר.`
              },
              {
                role: 'user',
                content: [

...
export async function POST(request: NextRequest) {
  try {
    ...
    const incomeData: any = {
      ...
      actual_bank_amount: body.actual_bank_amount || null,
      employer_name: body.employer_name?.trim() || null,
      pension_contribution: body.pension_contribution || null,
      advanced_study_fund: body.advanced_study_fund || null,
      other_deductions: body.other_deductions || null,

...
🚨 **חשוב — תשואות**: הדוח מכיל בעמוד "פירוט מסלולי השקעה" (בדרך כלל עמודים 29-30) טבלה עם **תשואות שנתיות ממוצעות** ב-12/24/36/60 חודשים אחרונים, וסטיות תקן ב-36/60 חודשים, וחשיפה למניות. **חובה לחלץ את הנתונים האלה** עבור כל מסלול ולשייך לתוכנית המתאימה לפי שם המסלול (\`investment_track\`).

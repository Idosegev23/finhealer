...
**דוגמאות:**
- יתרה: 5,000 → 15,000 (+10,000) → **income**
- יתרה: 15,000 → 14,650 (-350) → **expense**
- יתרה: -31,751 → -29,251 (+2,500) → **income** (החוב קטן!)
- יתרה: -29,251 → -29,601 (-350) → **expense** (החוב גדל!)
...
- ✅ "בנק לאומי - הלוואה" → category: "loan_payment", lender_name: "בנק לאומי"
- ✅ "בנק דיסקונט - משכנתא" → category: "loan_payment", lender_name: "בנק דיסקונט"
- ❌ "בנק הפועלים" בלי "הלוואה" → לא loan_payment!

...
### **זיהוי הכנסות vs הוצאות - BALANCE_AFTER vs BALANCE_BEFORE:**

**🔑 הכלל הפשוט - תמיד עובד!**

**חשב את ההפרש: balance_after - balance_before**

1. **אם ההפרש חיובי (+) → שים ב-"income"** (הכסף גדל!)
2. **אם ההפרש שלילי (-) → שים ב-"expenses"** (הכסף קטן!)

**זהו! זה עובד תמיד - גם ביתרה חיובית וגם ביתרה שלילית!**

---

**דוגמאות - יתרה חיובית (רגיל):**
✅ יתרה לפני: 5,000 | יתרה אחרי: 15,000 → הפרש: +10,000 → **income** (משכורת!)
✅ יתרה לפני: 15,000 | יתרה אחרי: 14,650 → הפרש: -350 → **expenses** (קניה!)
✅ יתרה לפני: 10,000 | יתרה אחרי: 18,000 → הפרש: +8,000 → **income**
✅ יתרה לפני: 18,000 | יתרה אחרי: 17,500 → הפרש: -500 → **expenses**

**דוגמאות - יתרה שלילית (מינוס/מסגרת/overdraft):**
✅ יתרה לפני: -31,751 | יתרה אחרי: -29,251 → הפרש: +2,500 → **income** (החוב קטן!)
✅ יתרה לפני: -29,251 | יתרה אחרי: -29,601 → הפרש: -350 → **expenses** (החוב גדל!)
✅ יתרה לפני: -10,000 | יתרה אחרי: -5,000 → הפרש: +5,000 → **income** (הכסף גדל!)
✅ יתרה לפני: -5,000 | יתרה אחרי: -5,500 → הפרש: -500 → **expenses** (הכסף קטן!)

**🎯 הטריק:** כשהיתרה שלילית, מספר "גדול יותר" (כמו -29,251) הוא למעשה **יותר כסף** מאשר מספר "קטן יותר" (כמו -31,751)!

...
## **🚨 🚨 🚨 חוק ברזל - הכלל היחיד שחשוב! 🚨 🚨 🚨**

### **זיהוי הכנסות vs הוצאות - יתרה לפני ויתרה אחרי!**

**🔥 הכלל היחיד - אל תסתכל על שום דבר אחר! 🔥**
...
**זהו! זה הכל! לא משנה מה כתוב בתיאור - רק היתרות קובעות!**
...
**יתרה חיובית (רגיל):**
- יתרה לפני: 5,000 | אחרי: 15,000 → +10,000 → **income**
- יתרה לפני: 15,000 | אחרי: 14,650 → -350 → **expenses**
- יתרה לפני: 10,000 | אחרי: 18,000 → +8,000 → **income**

**יתרה שלילית (מסגרת/מינוס):**
- יתרה לפני: -31,751 | אחרי: -29,251 → +2,500 → **income**
- יתרה לפני: -29,251 | אחרי: -29,601 → -350 → **expenses**
- יתרה לפני: -10,000 | אחרי: -5,000 → +5,000 → **income**
- יתרה לפני: -5,000 | אחרי: -5,500 → -500 → **expenses**

**🎯 טיפ:** כשהיתרה שלילית, -5,000 זה יותר כסף מאשר -10,000!

---

**⚠️ אל תסתכל על:**
- שם הספק (מס הכנסה, ביטוח לאומי, וכו')
- תיאור העסקה (זכות, חובה, העברה)
- סוג התשלום

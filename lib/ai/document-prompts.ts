...
**🔥 הכלל הגמיש - תסתכל על המבנה של הדוח! 🔥**
...
- דוגמה: זכות: 2,000.00 | חובה: - → income
- דוגמה: זכות: - | חובה: 500.00 → expense

**מצב 2: עמודה אחת "זכות/חובה"** (בנק דיסקונט)
- **מספר חיובי (+)** = זכות → type: "income" ✅
- **מספר שלילי (-)** = חובה → type: "expense" ❌
- דוגמה: זכות/חובה: 2,500.00 → income
- דוגמה: זכות/חובה: 591.61- → expense

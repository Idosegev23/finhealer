...
**🔥 תסתכל על עמודת "זכות/חובה" - זה הכי פשוט! 🔥**

**הכלל:**
- עמודת "זכות/חובה" (העמודה השלישית בדוח)
- **מספר שלילי (-)** = חובה = type: "expense"
- **מספר חיובי (+)** = זכות = type: "income"

**דוגמאות מהדוח:**
- יתרה: 31,751.31- | זכות/חובה: **85.43-** → expense (חובה)
- יתרה: 29,251.31- | זכות/חובה: **2,500.00** → income (זכות)
- יתרה: 29,842.92- | זכות/חובה: **591.61-** → expense (חובה)
- יתרה: 50,859.46- | זכות/חובה: **1,530.95** → income (זכות)

**⚠️ חשוב:** אל תחשב balance_after - balance_before! פשוט תסתכל על העמודה "זכות/חובה"!

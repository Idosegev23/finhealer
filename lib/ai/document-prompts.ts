...
**הכלל היחיד שחשוב:**
1. **אם balance_after > balance_before → שים ב-"income"** (הכסף גדל!)
2. **אם balance_after < balance_before → שים ב-"expenses"** (הכסף קטן!)

**זהו! אל תתבלבל!**

**דוגמאות ברורות:**
✅ יתרה לפני: 5,000 | יתרה אחרי: 15,000 → הכסף גדל → **income**
✅ יתרה לפני: 15,000 | יתרה אחרי: 14,650 → הכסף קטן → **expenses**
✅ יתרה לפני: 10,000 | יתרה אחרי: 18,000 → הכסף גדל → **income** (משכורת!)
✅ יתרה לפני: 18,000 | יתרה אחרי: 17,500 → הכסף קטן → **expenses** (קניה!)

...
**🔥 הכלל הפשוט והברור - תסתכל על הסימן של הסכום! 🔥**

**כלל ראשי - פשוט וברור:**
- **אם הסכום מתחיל במינוס (-)** → type: "expense" ❌ (הוצאה)
- **אם הסכום חיובי או מתחיל בפלוס (+)** → type: "income" ✅ (הכנסה)

**דוגמאות ברורות:**
- `-500.00` → expense (הוצאה של 500 ש"ח)
- `2,500.00` → income (הכנסה של 2500 ש"ח)
- `+1,000.00` → income (הכנסה של 1000 ש"ח)
- `591.61-` → expense (הוצאה של 591.61 ש"ח)

...
- ✅ **הודעה מעודדת** - "φ (פאי) המאמן שלך ב-WhatsApp"
...
<label>
  ...
  כולל: התראות על הוצאות, סיכומים יומיים, טיפים פיננסיים ושיחה עם המאמן הפיננסי שלי "φ (פאי)"
</label>
```
...
ושיחה עם המאמן הפיננסי שלי "φ (פאי)"
```

### **הודעה מעודדת (אם סימן V):**
```
🤖 φ (פאי) המאמן שלך ב-WhatsApp: 

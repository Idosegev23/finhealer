...
import { Home, Shield, Smartphone, Car, Baby, Heart, Tv, Zap, Save, ArrowRight, Loader2 } from 'lucide-react';
...
const expenseCategories = [
  {
    ...
    fields: [
      { key: 'rent_mortgage', label: 'שכר דירה / משכנתא', placeholder: '0' },
      { key: 'building_maintenance', label: 'דמי ניהול / ועד בית', placeholder: '0' },
      { key: 'property_tax', label: 'ארנונה', placeholder: '0' },
    ]
  },
  {
    category: 'ביטוחים',
    ...
    fields: [
      { key: 'life_insurance', label: 'ביטוח חיים', placeholder: '0' },
      { key: 'health_insurance', label: 'ביטוח בריאות', placeholder: '0' },
      { key: 'car_insurance', label: 'ביטוח רכב', placeholder: '0' },
      { key: 'home_insurance', label: 'ביטוח דירה', placeholder: '0' },
    ]
  },
  {
    category: 'תקשורת',
    ...
    fields: [
      { key: 'cellular', label: 'סלולר', placeholder: '0' },
      { key: 'internet', label: 'אינטרנט', placeholder: '0' },
      { key: 'tv_cable', label: 'טלוויזיה / כבלים', placeholder: '0' },
    ]
  },
  {
    ...
    fields: [
      { key: 'leasing', label: 'ליסינג / החזר הלוואה לרכב', placeholder: '0' },
      { key: 'fuel', label: 'דלק', placeholder: '0' },
      { key: 'parking', label: 'חניה', placeholder: '0' },
      { key: 'public_transport', label: 'תחבורה ציבורית', placeholder: '0' },
    ]
  },
  {
    ...
    fields: [
      { key: 'daycare', label: 'מעון / גן', placeholder: '0' },
      { key: 'afterschool', label: 'צהרון', placeholder: '0' },
      { key: 'tuition', label: 'שכר לימוד', placeholder: '0' },
      { key: 'extracurricular', label: 'חוגים', placeholder: '0' },
      { key: 'babysitter', label: 'בייביסיטר', placeholder: '0' },
    ]
  },
  {
    ...
    fields: [
      { key: 'gym', label: 'חדר כושר', placeholder: '0' },
      { key: 'therapy', label: 'טיפולים', placeholder: '0' },
      { key: 'medication', label: 'תרופות', placeholder: '0' },
    ]
  },
  {
    category: 'מנויים',
    ...
    fields: [
      { key: 'streaming', label: 'שירותי סטרימינג', placeholder: '0' },
      { key: 'digital_services', label: 'שירותים דיגיטליים', placeholder: '0' },
    ]
  },
  {
    ...
    fields: [
      { key: 'electricity', label: 'חשמל', placeholder: '0' },
      { key: 'water', label: 'מים', placeholder: '0' },
      { key: 'gas', label: 'גז', placeholder: '0' },
    ]
  },
];
          ...
          >
            ...
            <div className="space-y-3">
              {category.fields.map(field => (
                <div key={field.key}>
                  <Label htmlFor={field.key} className="text-sm text-[#555555]">{field.label}</Label>

  ...
  goals: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'לחיצה על הכפתור הזה תפתח חלון להוספת יעד. תזין שם, סכום, תאריך, וסוג (חיסכון/רכישה/החזר חוב). זהו, סיימת.',
      ...
      },
      {
        ...
        tip: 'מחיקה דורשת אישור — אז לא תמחק בטעות. אם לא בטוח, עדיף "ערוך" ולא "מחק".',
      },
    ],
  },
  ...
  expenses: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'הכפתור הזה — להוצאה במזומן או משהו שלא תפסתי בדוח. תזין תאריך, סכום, וקטגוריה.',
      },
      {
        id: 'list',
  ...
  investments: {
    ...
    steps: [
      ...
      },
      {
        ...
        placement: 'top',
        title: 'הניירות שלך',
        body: 'באזור הזה תזין או תעדכן כל השקעה ספציפית. אפשר להזין שם נייר, כמות, מחיר. אני אעדכן את השווי לבד מנתוני השוק.',
      },
      {
        id: 'returns',
        selector: null,
